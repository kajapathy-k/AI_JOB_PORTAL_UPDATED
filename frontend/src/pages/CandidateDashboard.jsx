    ...
    <div className="card flex flex-col gap-4 p-5 sm:flex-row sm:items-center">
      ...
      <div className="flex-1">
        <div className="flex flex-wrap items-center gap-2">
          <h3 className="text-base font-semibold text-white">{job.title || "Job"}</h3>
...
export default function CandidateDashboard() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <p className="mt-1 text-sm text-slate-400">Track screening results and interview invites.</p>
      ...
      <div className="mt-6 space-y-4">
        ...
        {apps && apps.length === 0 && (
          <div className="card p-8 text-center">
            <p className="text-slate-300">You haven’t applied to anything yet.</p>
