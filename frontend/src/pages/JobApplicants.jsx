      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex flex-wrap items-center gap-2">
            <h3 className="text-base font-semibold text-white">{app.candidate_name}</h3>
...
export default function JobApplicants() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <Link to="/recruiter" className="text-sm text-brand-300 hover:underline">
        ← Back to dashboard
      </Link>
      ...
      <div className="mt-6 space-y-4">
        ...
        {!apps && !error && <Spinner />}
        {apps && apps.length === 0 && (
          <div className="card p-8 text-center text-slate-300">No applicants yet.</div>
        )}
        {apps?.map((a) => (
